...
const RentalModal: React.FC<RentalModalProps> = ({
  ...
  const modalContent = (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-start z-50" style={{zIndex: 1000}}>
      <div className="bg-white shadow-xl w-full h-full sm:w-full sm:max-w-2xl sm:h-auto sm:max-h-screen sm:rounded-lg modal-container overflow-y-auto flex flex-col" style={{position: 'relative', zIndex: 1001}}>
