  ...
  return (
    <>
      <div className="fixed bottom-4 right-4 sm:bottom-8 sm:right-8 z-40 flex flex-col space-y-3 sm:space-y-4">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-br from-primary-500 to-primary-600 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity blur"></div>
          <Phone className="relative w-5 h-5 sm:w-6 sm:h-6 group-hover:animate-bounce" />
        </button>
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-br from-green-400 to-green-500 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity blur"></div>
          <svg className="relative w-5 h-5 sm:w-6 sm:h-6 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a
          ...
          className="group relative w-9 h-9 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-xl shadow-2xl hover:shadow-blue-500/50 flex items-center justify-center transition-all duration-300 hover:scale-110"
          title="Написать в Telegram"
        >
          <div className="absolute inset-0 bg-gradient-to-br from-blue-400 to-blue-500 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity blur"></div>
          <svg className="relative w-5 h-5 sm:w-6 sm:h-6 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-br from-violet-400/10 to-violet-500/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
          <img src={maxIcon} alt="Max" className="relative w-6 h-6 sm:w-7 sm:h-7 group-hover:scale-110 transition-transform rounded-lg" />
        </a>
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-br from-[#0AF]/10 to-[#09D]/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
          <img src={avitoIcon} alt="Avito" className="relative w-5 h-5 sm:w-6 sm:h-6 group-hover:scale-110 transition-transform rounded-lg" />
        </a>
      </div>
