...
import { AVITO_PROFILE_URL, CONTACT_PHONE, CONTACT_PHONE_LABEL, getTelegramUrl, getWhatsAppUrl, MAX_URL } from '../../lib/contactLinks'
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <a href={getTelegramUrl()} target="_blank" rel="noopener noreferrer"
                className="w-10 h-10 bg-[#2AABEE] rounded-xl flex items-center justify-center text-white hover:opacity-90 transition-opacity">
        ...
        <div className="border-t border-gray-800 mt-6 pt-5 flex flex-col sm:flex-row justify-between items-center gap-3 pb-20 md:pb-0">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <Link to="/return-policy" className="text-gray-600 hover:text-gray-400 text-xs transition-colors">Возврат и отказ от услуги</Link>
