            ...
            <div>
                ...
                {[
                  {
                    ...
                    bg: 'bg-[#2563EB]',
                    title: 'Телефон',
                    content: <a href={`tel:${CONTACT_PHONE}`} onClick={() => trackEvent('phone_click', { source: 'contact_card' })} className="text-gray-700 hover:text-[#2563EB] transition-colors font-medium">{CONTACT_PHONE_LABEL}</a>,
                  },
                  {
                    icon: (
                      <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <a href={getTelegramUrl()} target="_blank" rel="noopener noreferrer" onClick={() => trackEvent('telegram_click', { source: 'contact_socials' })}
                    className="w-14 h-14 bg-[#2AABEE] rounded-xl flex items-center justify-center text-white hover:opacity-90 transition-opacity shadow-lg shadow-sky-500/20">
                  ...
                  <a href={getWhatsAppUrl()} target="_blank" rel="noopener noreferrer" onClick={() => trackEvent('whatsapp_click', { source: 'contact_socials' })}
                  ...
                  <a href={MAX_URL} target="_blank" rel="noopener noreferrer" onClick={() => trackEvent('max_click', { source: 'contact_socials' })}
                  ...
                  <a href={AVITO_PROFILE_URL}
                    target="_blank" rel="noopener noreferrer"
                    onClick={() => trackEvent('avito_click', { source: 'contact_socials' })}
                    className="w-12 h-12 bg-white border border-gray-200 rounded-xl flex items-center justify-center hover:shadow-sm transition-shadow overflow-hidden">
