...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Немедленно сообщите нам о поломке по телефону +7 (917) 525-50-95. Наши специалисты оперативно заменят неисправное оборудование или проведут ремонт на месте."
  },
  {
