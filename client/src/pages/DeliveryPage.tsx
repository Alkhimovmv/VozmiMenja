              ...
              <div>
                ...
                <ul className="space-y-1.5 text-sm text-gray-700">
                  {[
                    ...
                    'Бесплатная доставка при заказе от 10 000₽ в пределах Москвы',
                  ].map((item) => (
                    <li key={item}>• {item}</li>
                  ))}
                </ul>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-8 text-center shadow-sm">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <a href="tel:+79933636464"
                ...
                <Truck className="w-4 h-4" /> Заказать доставку
              </a>
              <a href="https://wa.me/79933636464" target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1DAE54] text-white font-semibold px-6 py-3 rounded-2xl transition-colors">
                Написать в WhatsApp
              </a>
            </div>
          </div>
