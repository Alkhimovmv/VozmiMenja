        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-8 mb-6 shadow-sm">
            ...
            <div className="space-y-5">
              {[
                { n: '1', title: 'Заказ доставки', text: 'Доставка заказывается при оформлении бронирования или в Telegram. Укажите желаемое время и адрес доставки.' },
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-8 text-center shadow-sm">
            ...
            <p className="text-gray-500 text-sm mb-6">Напишите в Telegram — быстро прикинем доставку, срок и удобный способ получения</p>
            <div className="flex flex-wrap justify-center gap-3">
              <a
                href={getTelegramUrl()}
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => trackEvent('telegram_click', { source: 'delivery_cta' })}
              ...
              <a
                ...
                onClick={() => trackEvent('phone_click', { source: 'delivery_cta' })}
                className="inline-flex items-center gap-2 bg-white hover:bg-gray-50 text-gray-800 border border-gray-200 font-semibold px-6 py-3 rounded-2xl transition-colors"
              >
                <Phone className="w-4 h-4" /> {CONTACT_PHONE_LABEL}
              </a>
            </div>
          </div>
        </div>
