...
const kitItems = [
  'После ремонта: WD5, мешок/фильтр под пыль, насадка для пола, срок 1–2 дня',
  'Сухая строительная пыль: уточнение гипс/бетон/дерево, запасной мешок по задаче',
  'Финальная уборка: WD5 для сухой пыли плюс SC4 для плитки и швов',
  'Текстиль после ремонта: сначала WD5, затем Puzzi для дивана, ковра или матраса',
]
